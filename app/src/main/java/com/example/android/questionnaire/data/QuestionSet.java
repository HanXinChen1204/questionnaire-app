...
public class QuestionSet {
    ...
    public static ArrayList<Question> getAllQuestions(Context context) {
        ...
        Question question2 = new Question(context.getString(R.string.q2), Options.CHECKBOX, context.getResources().getStringArray(R.array.q2_options), Arrays.asList(0, 1, 2));
        ...
        Question question5 = new Question(context.getString(R.string.q5), CHECKBOX, context.getResources().getStringArray(R.array.q5_options), Arrays.asList(0, 2, 3));
        questions.add(question5);

        Question question6 = new Question(context.getString(R.string.q6), RADIOBUTTON, context.getResources().getStringArray(R.array.q6_options), Collections.singletonList(2));
